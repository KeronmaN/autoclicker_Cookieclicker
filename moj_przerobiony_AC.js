...
AutoClicker.init = function() {
  ...
  window.setTimeout(() => {
    ...
    AutoClicker.AutoClickInterval = window.setInterval(AutoClicker.ClickCookie, 100);
    AutoClicker.GoldenClickInterval = window.setInterval(AutoClicker.ClickGoldenCookie, 15);
    AutoClicker.FortuneClickInterval = window.setInterval(AutoClicker.ClickFortune, 15);
  }, 5000);
